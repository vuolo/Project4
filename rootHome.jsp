   ...
   <body>
     <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
       ...
       <div style="display: flex; flex-direction: column;">
         <p style="text-align: center">You are connected to the Project 4 Enterprise System database as a <span style="color: red">root-level</span> user.
           <br>
           Please enter any valid SQL query or update command in the box below.
         </p>
 
         <form action="RootUserApp" method="get" style="margin-top: 10px;">
